...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {normes?.active && normes.last_run && normes.last_run.n_evaluees > 0 && (
        <Link to="/conformite" className="block bg-white rounded-lg border border-gray-200 p-3 sm:p-4 hover:bg-gray-50">
          <div className="flex flex-wrap items-center gap-x-6 gap-y-1 text-sm">
            <span className="font-medium text-gray-700">Conformité aux normes</span>
            <span className="text-2xl font-bold text-gray-900">{((100 * normes.last_run.n_conformes) / normes.last_run.n_evaluees).toFixed(1)}%</span>
